...
import com.application.course_management.persistence.reports.PassingStudentsReport;
...
public class PassingStudentsReportDAO extends ReportDAO {
	private static final String COLLECTION_NAME = "passing_students_reports";
	...
	public List<Report> getReports(Teacher teacher) throws UnknownHostException {
		...
		while(cursor.hasNext()) {
			...
			Report report = new PassingStudentsReport();
			...
			((PassingStudentsReport)report).setEnrollments(enrollments);
